...
public class SockDeciderHelper {
	...
	public static Random RAND_FOR_BUTTERFLY = new Random(23L);
	...
	public static List<String> getAllSubStepsName(GenericParallelStep possibleLogicalStep) {
		final List<String> allSubStepNames = possibleLogicalStep.getSubSteps().stream().map(substep -> substep.getMseoccurrence().getMse().getName())
				.collect(Collectors.toList());
//		System.out.println("allSubStepNames >> " + allSubStepNames);
		return allSubStepNames;
	}
